...
<div class="main">
    ...
    <span><input type="text" id="key" name="key" placeholder="Merchant Key" value="TfgcGk" /></span>
    </div>
    
    <div class="dv">
    <span class="text"><label>Merchant Salt:</label></span>
    <span><input type="text" id="salt" name="salt" placeholder="Merchant Salt" value="618adb07252839ebf0adfbc6ea10cfe4" /></span>
    </div>
